/* 
    Parses input data and replaces all the tabs with empty spaces
    and all the written numbers into symbol numbers
    RETURN -> string with spaces instead of tabs and symbol numbers instead of written
*/
...
/*
    Finds the hidden number in each row and adds it to the "total" variable
    RETURN -> the sum of the hidden numbers from each row
*/
function sumHiddenNumbers(str) {
    let total = 0;
    let num1 = 0;
    let num2 = 0;
    for (let i = 0; i < str.length; i++) {
        ...
        switch (element) {
            case "1":
                if (num1 == 0) { num1 = "1"; break }
                if (num1 != 0) { num2 = "1"; }
                break;
            case "2":
                if (num1 == 0) { num1 = "2"; break }
                if (num1 != 0) { num2 = "2"; }
                break;
            case "3":
                if (num1 == 0) { num1 = "3"; break }
                if (num1 != 0) { num2 = "3"; }
                break;
            case "4":
                if (num1 == 0) { num1 = "4"; break }
                if (num1 != 0) { num2 = "4"; }
                break;
            case "5":
            ...
            case "6":
                ...
                break;
            case "7":
                if (num1 == 0) { num1 = "7"; break }
                if (num1 != 0) { num2 = "7"; }
                break;
            case "8":
                if (num1 == 0) { num1 = "8"; break }
                if (num1 != 0) { num2 = "8"; }
                break;
            case "9":
                if (num1 == 0) { num1 = "9"; break }
                if (num1 != 0) { num2 = "9"; }
                break;
            case " ":
                if (num2 == 0) {
...
/* 
    Input data recovered from [https://adventofcode.com/2023/day/1/input],
    the format you see is how it was copied from the website, I added a tab to the final row
*/
const txt = `six1mpffbnbnnlxthree
4eight3one92
9nine2xnhvjtjlzj48
